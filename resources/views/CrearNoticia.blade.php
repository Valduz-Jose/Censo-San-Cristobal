                        ...
                        <div class="row justify-content-center">
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input name="titulo" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Titulo">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea name="descripcion" class="form-control" placeholder="Contenido" id="exampleFormControlTextarea1" rows="3"></textarea>
                                </div>
